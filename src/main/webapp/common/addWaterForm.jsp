...
<div class="container" style="width: 400px;">
    ...
    <form action="#" method="post" id="myform">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="electric" name="electric" value="" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="lastTime">上次抄表时间：</label>
            <input type="date" id="lastTime" class="form-control" name="lastTime" value="" />
        </div>
        <div class="form-group">
            <label for="nowTime">本次抄表时间：</label>
            <input type="date" id="nowTime" class="form-control" name="nowTime" value="" />
        </div>
        <div class="form-group">
            <label for="paytime">缴费时间：</label>
            <input type="date" id="paytime" class="form-control" name="paytime" value="" />
        </div>
        <div class="form-group">
